...
- Diagnostic classifier 1D legacy: tổng lợi nhuận -27.1%; Sharpe -1.64; mức sụt giảm tối đa -27.7%.
...
|---|---|---:|---:|---:|---:|---:|---|
| Gốc | Ngưỡng gốc ≥ 0.55 | 42 | -10.3% | 20.6% | -27.1% | -1.64 | Baseline lịch sử để đo turnover/phí; không phải số lệnh khuyến nghị. |
...
| Giới hạn 10 vòng | Tối đa 10 vòng, ưu tiên xác suất cao hơn | 10 | -5.6% | 4.9% | -10.1% | -0.93 | Ngưỡng trong nhóm: 59.2%. Không dùng làm rule vì chọn số vòng sau khi đã thấy OOS. |
...
- Mức dừng lỗ 31.16; mục tiêu 1 35.36; mục tiêu 2 35.36.
- Tỷ lệ lợi nhuận/rủi ro 5.04; khối lượng vị thế 0 cổ phiếu.

## Dự báo 20 phiên

- P50 cuối kỳ 31.62 (-0.27%).
- P10/P90 cuối kỳ 28.13 / 35.36.
...
- Điều kiện phát hành tín hiệu: Expected excess return -0.0015811404446139932 chưa vượt chi phí + margin 0.0100..
...
- Mức dừng lỗ tham chiếu 31.16, mục tiêu 1 35.36, tỷ lệ lợi nhuận/rủi ro 5.04.
