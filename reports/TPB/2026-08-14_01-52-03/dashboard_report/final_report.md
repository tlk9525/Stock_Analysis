# Báo cáo ngày 2026-08-14 - TPB

## Tổng quan

- Dữ liệu: 2018-04-19 -> 2026-08-13, 2,078 phiên.
- Giá đóng cửa: 14.45 nghìn VND/cp.
...
- SMA20 14.43; SMA60 15.50; RSI14 42.1.
- MACD -0.224; đường tín hiệu -0.315; biểu đồ cột 0.091.
- ATR14 0.37; ATR% 2.5%; ADX14 21.1.
- Xu hướng: Cẩn thận - Giá nằm dưới SMA60.
- MACD: Tích cực - MACD trên signal, histogram dương.
- RSI14: Yếu - RSI 42.1.
- Bollinger: Ổn định - Giá nằm trong dải Bollinger.
- ADX: Đi ngang - ADX 21.1.
...
- ROE: 16.8%.
- ROA: 1.5%.
- Market cap: 40,778.5 tỷ.
- Revenue Growth: 12.6%.
- Profit Growth: 19.9%.
- P/E 5.31: định giá tương đối thấp nếu lợi nhuận bền vững.
- P/B 0.89: nên đọc cùng ROE và đặc thù ngành.
...
- Bài mới nhất: 2026-08-11T07:49:18+00:00.
...
- XGBoost: độ chính xác cân bằng 0.511; AUC 0.553; log-loss 0.686.
- Mô hình Logistic đối chứng: độ chính xác cân bằng 0.520; AUC 0.560.
...
- Mức độ quan trọng của đặc trưng: bb_position_20=9.39; stoch_k_14=9.07; day_of_week=8.86; month_of_year=8.41; return_1d=8.39; close_vs_sma20=8.34.

## Quản trị rủi ro

- Vốn tham chiếu 100,000,000 VND; rủi ro mỗi lệnh 1.0%.
- Mức dừng lỗ 13.90; mục tiêu 1 15.50; mục tiêu 2 16.20.
- Tỷ lệ lợi nhuận/rủi ro 1.57; khối lượng vị thế 0 cổ phiếu.

## Dự báo 20 phiên

- Phương pháp: XGBoost direct quantile 5/10/20D + conformal calibration; toàn bộ horizon qua gate: chưa.
- P50 cuối kỳ 14.51 (0.39%).
- P10/P90 cuối kỳ 13.05 / 16.20.
...
- Điều kiện phát hành tín hiệu: Cận dưới expected excess return -0.027223784949636398 (dự báo điểm 0.0016764632891863585) chưa vượt chi phí + margin 0.0100..
...
- Quantile forecast ước tính xác suất return cuối kỳ dương từ residual frozen holdout: 43.3%.
- Mức dừng lỗ tham chiếu 13.90, mục tiêu 1 15.50, tỷ lệ lợi nhuận/rủi ro 1.57.
...
- Tóm tắt: ML decision hiện giữ nguyên NO_EDGE. News Reader đã trích đoạn có nguồn của 1 bài để phân loại chủ đề (vi_mo: 1, nganh: 1), nhưng các trích đoạn này không tạo bằng chứng mới cho quyết định đầu tư.
- Góc nhìn kỹ thuật: Artifact kỹ thuật: bias Trung tính; điểm -1. Chi tiết artifact: Xu hướng: Cẩn thận (Giá nằm dưới SMA60.); MACD: Tích cực (MACD trên signal, histogram dương.); RSI14: Yếu (RSI 42.1.); Bollinger: Ổn định (Giá nằm trong dải Bollinger.); ADX: Đi ngang (ADX 21.1.); Thanh khoản: Bình thường (0.71 lần trung bình.); Stochastic: Yếu lại (%K nằm dưới %D.)
- Góc nhìn cơ bản: Artifact cơ bản: TPBank; kỳ 2026-Q2; P/E 5.31; P/B 0.89; ROE 16.8%; ROA 1.5%; Debt/Equity 10.05; Revenue Growth 12.6%; Profit Growth 19.9%.
...
- Live research: Live snapshot lấy lúc 2026-08-13T18:52:21.619738+00:00; News Reader đọc được 1 bài. ML có 10 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.027223784949636398 (dự báo điểm 0.0016764632891863585) chưa vượt chi phí + margin 0.0100.
...
- ML guard: Cận dưới expected excess return -0.027223784949636398 (dự báo điểm 0.0016764632891863585) chưa vượt chi phí + margin 0.0100.
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/TPB/2026-08-14_01-52-03/all_files/symbol_news_model`
- Số bài tin trong CSV cho mã: 1
- Số dòng giá có news feature: 3
- XGBoost probability mới nhất: 0.539
- AUC OOS: 0.551
