# Báo cáo ngày 2026-08-14 - PAN

## Tổng quan

- Dữ liệu: 2010-12-15 -> 2026-08-13, 3,858 phiên.
...
- SMA20 20.88; SMA60 22.33; RSI14 36.7.
- MACD -0.348; đường tín hiệu -0.394; biểu đồ cột 0.046.
- ATR14 0.51; ATR% 2.5%; ADX14 39.1.
- Xu hướng: Cẩn thận - Giá nằm dưới SMA60.
- MACD: Tích cực - MACD trên signal, histogram dương.
- RSI14: Yếu - RSI 36.7.
- Bollinger: Ổn định - Giá nằm trong dải Bollinger.
- ADX: Xu hướng giảm - ADX 39.1, -DI vượt +DI.
- Thanh khoản: Đột biến - 2.16 lần trung bình.
...
- ROE: 22.6%.
- ROA: 7.5%.
- Market cap: 5,188.9 tỷ.
- Revenue Growth: -10.1%.
- Profit Growth: 51.4%.
- P/E 4.25: định giá tương đối thấp nếu lợi nhuận bền vững.
...
- Mô hình Logistic đối chứng: độ chính xác cân bằng 0.508; AUC 0.490.
...
- Mức độ quan trọng của đặc trưng: return_1d=16.84; return_kurtosis_20d=14.17; return_5d=13.02; atr_pct_14=11.77; rsi_14=11.60; market_volatility_20d=11.00.

## Quản trị rủi ro

- Vốn tham chiếu 100,000,000 VND; rủi ro mỗi lệnh 1.0%.
- Mức dừng lỗ 19.73; mục tiêu 1 23.63; mục tiêu 2 23.63.
- Tỷ lệ lợi nhuận/rủi ro 3.47; khối lượng vị thế 0 cổ phiếu.

## Dự báo 20 phiên

- Phương pháp: XGBoost direct quantile 5/10/20D + conformal calibration; toàn bộ horizon qua gate: chưa.
- P50 cuối kỳ 20.54 (0.18%).
- P10/P90 cuối kỳ 17.59 / 23.63.
...
- Điều kiện phát hành tín hiệu: Cận dưới expected excess return -0.043440757624761406 (dự báo điểm 0.0001454383018426597) chưa vượt chi phí + margin 0.0100..
...
- Quantile forecast ước tính xác suất return cuối kỳ dương từ residual frozen holdout: 35.7%.
- Mức dừng lỗ tham chiếu 19.73, mục tiêu 1 23.63, tỷ lệ lợi nhuận/rủi ro 3.47.
...
- Tóm tắt: ML decision hiện giữ nguyên NO_EDGE. News Reader đã trích đoạn có nguồn của 2 bài để phân loại chủ đề (chưa có nhóm khớp rule), nhưng các trích đoạn này không tạo bằng chứng mới cho quyết định đầu tư.
- Góc nhìn kỹ thuật: Artifact kỹ thuật: bias Suy yếu / cẩn thận; điểm -2. Chi tiết artifact: Xu hướng: Cẩn thận (Giá nằm dưới SMA60.); MACD: Tích cực (MACD trên signal, histogram dương.); RSI14: Yếu (RSI 36.7.); Bollinger: Ổn định (Giá nằm trong dải Bollinger.); ADX: Xu hướng giảm (ADX 39.1, -DI vượt +DI.); Thanh khoản: Đột biến (2.16 lần trung bình.); Stochastic: Yếu lại (%K nằm dưới %D.)
- Góc nhìn cơ bản: Artifact cơ bản: Tập đoàn PAN; kỳ 2026-Q2; P/E 4.25; P/B 0.97; ROE 22.6%; ROA 7.5%; Debt/Equity 0.83; Revenue Growth -10.1%; Profit Growth 51.4%.
- Tin doanh nghiệp: Đã đọc trích đoạn giới hạn của 2 bài; phân nhóm rule-based: chưa có nhóm khớp rule. Tác động cần kiểm chứng: mở URL gốc để xác minh bối cảnh. Đây không phải sentiment hay dự báo tác động giá.
- Live research: Live snapshot lấy lúc 2026-08-13T18:26:00.674947+00:00; News Reader đọc được 2 bài. ML có 7 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.043440757624761406 (dự báo điểm 0.0001454383018426597) chưa vượt chi phí + margin 0.0100.
...
- ML guard: Cận dưới expected excess return -0.043440757624761406 (dự báo điểm 0.0001454383018426597) chưa vượt chi phí + margin 0.0100.
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/PAN/2026-08-14_01-25-34/all_files/symbol_news_model`
