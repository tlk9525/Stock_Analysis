...
- Góc nhìn kỹ thuật: Artifact kỹ thuật: bias Hồi phục / nghiêng tăng; điểm 2. Chi tiết artifact: Xu hướng: Trung tính (Giá trên SMA60 nhưng chưa vượt SMA20.); MACD: Tích cực (MACD trên signal, histogram dương.); RSI14: Tích cực (RSI 62.8.); Bollinger: Gần biên trên (Giá sát/vượt biên trên.); ADX: Đi ngang (ADX 21.9.); Thanh khoản: Bình thường (1.46 lần trung bình.); Stochastic: Yếu lại (%K nằm dưới %D.)
- Góc nhìn cơ bản: Artifact cơ bản: Vận tải Dầu khí PVTrans; kỳ 2026-Q2; P/E 7.42; P/B 1.12; ROE 15.9%; ROA 6.3%; Debt/Equity 0.89; Revenue Growth 32.5%; Profit Growth 87.6%.
...
- Live research: Live snapshot lấy lúc 2026-08-13T18:38:49.083944+00:00; News Reader đọc được 2 bài. ML có 4 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.04800279528283957 (dự báo điểm -0.009422626346349716) chưa vượt chi phí + margin 0.0100.
...
- ML guard: Cận dưới expected excess return -0.04800279528283957 (dự báo điểm -0.009422626346349716) chưa vượt chi phí + margin 0.0100.
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/PVT/2026-08-14_01-38-26/all_files/symbol_news_model`
- Số bài tin trong CSV cho mã: 2
- Số dòng giá có news feature: 3
- XGBoost probability mới nhất: 0.484
- AUC OOS: 0.514
