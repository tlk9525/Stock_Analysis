# Báo cáo ngày 2026-08-16 - BMP

## Tổng quan

- Dữ liệu: 2008-03-10 -> 2026-08-14, 4,578 phiên.
- Giá đóng cửa: 147.20 nghìn VND/cp.
- Xu hướng kỹ thuật nghiêng về: Suy yếu / cẩn thận (điểm -2).
- Xác suất XGBoost để giá đóng cửa phiên tới cao hơn giá mở cửa: 46.4%.
...
- SMA20 149.80; SMA60 146.11; RSI14 44.9.
- MACD -0.091; đường tín hiệu 0.297; biểu đồ cột -0.388.
- ATR14 2.95; ATR% 2.0%; ADX14 11.5.
- Xu hướng: Trung tính - Giá trên SMA60 nhưng chưa vượt SMA20.
- MACD: Cẩn thận - MACD dưới signal, histogram âm.
- RSI14: Yếu - RSI 44.9.
- Bollinger: Ổn định - Giá nằm trong dải Bollinger.
- ADX: Đi ngang - ADX 11.5.
- Thanh khoản: Bình thường - 0.97 lần trung bình.
- Stochastic: Cực trị - %K 11.3, %D 27.7.
...
- ROE: 42.6%.
- ROA: 35.3%.
- Market cap: 12,049.9 tỷ.
- Revenue Growth: 0.9%.
- Profit Growth: 11.3%.
- P/E 9.39: định giá tương đối thấp nếu lợi nhuận bền vững.
- P/B 4.23: nên đọc cùng ROE và đặc thù ngành.
...
- Kiểm thử: 2023-09-27 -> 2026-08-13.
- XGBoost: độ chính xác cân bằng 0.505; AUC 0.510; log-loss 0.699.
- Mô hình Logistic đối chứng: độ chính xác cân bằng 0.518; AUC 0.515.
...
- Mức độ quan trọng của đặc trưng: market_return_20d=15.97; volume_ratio_20=14.59; close_vs_sma20=14.41; stoch_k_14=13.48; day_of_week=13.37; market_return_5d=13.18.

## Quản trị rủi ro

- Vốn tham chiếu 100,000,000 VND; rủi ro mỗi lệnh 1.0%.
- Mức dừng lỗ 144.65; mục tiêu 1 156.00; mục tiêu 2 170.36.
- Tỷ lệ lợi nhuận/rủi ro 2.45; khối lượng vị thế 0 cổ phiếu.

## Dự báo 20 phiên

- Phương pháp: XGBoost direct quantile 5/10/20D + conformal calibration; toàn bộ horizon qua gate: chưa.
- P50 cuối kỳ 149.40 (1.49%).
- P10/P90 cuối kỳ 133.25 / 170.36.
...
- Điều kiện phát hành tín hiệu: Cận dưới expected excess return -0.052151731012781255 (dự báo điểm 0.00309497257694602) chưa vượt chi phí + margin 0.0100..
- Điều kiện phát hành tín hiệu: Technical score -2 < 2..
- Trung hạn chưa xấu, ngắn hạn yếu vì giá dưới SMA20.
- Xu hướng kỹ thuật nghiêng về: Suy yếu / cẩn thận.
- XGBoost ước tính xác suất giá đóng cửa phiên tới cao hơn giá mở cửa: 46.4%.
- Mô hình Logistic đối chứng: 53.2%.
- Quantile forecast ước tính xác suất return cuối kỳ dương từ residual frozen holdout: 52.8%.
- Mức dừng lỗ tham chiếu 144.65, mục tiêu 1 156.00, tỷ lệ lợi nhuận/rủi ro 2.45.
...
- Góc nhìn kỹ thuật: Artifact kỹ thuật: bias Suy yếu / cẩn thận; điểm -2. Chi tiết artifact: Xu hướng: Trung tính (Giá trên SMA60 nhưng chưa vượt SMA20.); MACD: Cẩn thận (MACD dưới signal, histogram âm.); RSI14: Yếu (RSI 44.9.); Bollinger: Ổn định (Giá nằm trong dải Bollinger.); ADX: Đi ngang (ADX 11.5.); Thanh khoản: Bình thường (0.97 lần trung bình.); Stochastic: Cực trị (%K 11.3, %D 27.7.)
- Góc nhìn cơ bản: Artifact cơ bản: Nhựa Bình Minh; kỳ 2026-Q2; P/E 9.39; P/B 4.23; ROE 42.6%; ROA 35.3%; Debt/Equity 0.18; Revenue Growth 0.9%; Profit Growth 11.3%.
- Tin doanh nghiệp: Không có snapshot tin đã lưu; không đưa ra nhận định tin tức.
- Live research: Live snapshot lấy lúc 2026-08-16T05:22:35.263115+00:00; News Reader đọc được 0 bài. ML có 9 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.052151731012781255 (dự báo điểm 0.00309497257694602) chưa vượt chi phí + margin 0.0100.
...
- ML guard: Cận dưới expected excess return -0.052151731012781255 (dự báo điểm 0.00309497257694602) chưa vượt chi phí + margin 0.0100.
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/BMP/2026-08-16_12-22-14/all_files/symbol_news_model`
- Số bài tin trong CSV cho mã: 0
- Số dòng giá có news feature: 0
- XGBoost probability mới nhất: 0.472
- AUC OOS: 0.512
- Balanced accuracy OOS: 0.500
- Backtest total return: 0.000
- Base XGBoost probability: 0.464
