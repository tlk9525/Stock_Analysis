...
- Góc nhìn kỹ thuật: Artifact kỹ thuật: bias Tích cực; điểm 5. Chi tiết artifact: Xu hướng: Trung tính (Giá trên SMA60 nhưng chưa vượt SMA20.); MACD: Tích cực (MACD trên signal, histogram dương.); RSI14: Tích cực (RSI 58.7.); Bollinger: Ổn định (Giá nằm trong dải Bollinger.); ADX: Xu hướng tăng (ADX 27.4, +DI vượt -DI.); Thanh khoản: Bình thường (1.36 lần trung bình.); Stochastic: Yếu lại (%K nằm dưới %D.)
- Góc nhìn cơ bản: Artifact cơ bản: Tổng Công ty Viglacera; kỳ 2026-Q2; P/E 12.70; P/B 2.15; ROE 16.2%; ROA 5.3%; Debt/Equity 1.36; Revenue Growth 38.2%; Profit Growth 28.4%.
...
- Live research: Live snapshot lấy lúc 2026-08-16T06:24:40.342699+00:00; News Reader đọc được 2 bài. ML có 5 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.048992462967732964 (dự báo điểm 0.003265228820964694) chưa vượt chi phí + margin 0.0050.
...
- ML guard: Cận dưới expected excess return -0.048992462967732964 (dự báo điểm 0.003265228820964694) chưa vượt chi phí + margin 0.0050.
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/VGC/2026-08-16_13-24-27/all_files/symbol_news_model`
...
- Base XGBoost probability: 0.469
