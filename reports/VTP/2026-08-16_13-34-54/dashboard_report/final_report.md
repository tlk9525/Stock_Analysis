# Báo cáo ngày 2026-08-16 - VTP

## Tổng quan

- Dữ liệu: 2018-11-23 -> 2026-08-14, 1,917 phiên.
- Giá đóng cửa: 53.50 nghìn VND/cp.
...
- SMA20 49.67; SMA60 52.95; RSI14 57.9.
- MACD 0.589; đường tín hiệu -0.305; biểu đồ cột 0.894.
- ATR14 2.13; ATR% 4.0%; ADX14 28.0.
...
- ROE: 18.5%.
- ROA: 4.8%.
- Market cap: 10,800.9 tỷ.
- Revenue Growth: 9.8%.
- Profit Growth: -24.8%.
- P/E 24.03: định giá cao, cần tăng trưởng lợi nhuận hỗ trợ.
- P/B 4.67: nên đọc cùng ROE và đặc thù ngành.
...
- XGBoost: độ chính xác cân bằng 0.513; AUC 0.534; log-loss 0.695.
...
- Mức độ quan trọng của đặc trưng: market_return_1d=8.80; return_skew_20d=8.70; close_vs_sma60=8.40; macd_pct=8.24; day_of_week=8.20; adx_14=8.14.

## Quản trị rủi ro

- Vốn tham chiếu 100,000,000 VND; rủi ro mỗi lệnh 1.0%.
- Mức dừng lỗ 52.42; mục tiêu 1 56.70; mục tiêu 2 64.64.
- Tỷ lệ lợi nhuận/rủi ro 2.17; khối lượng vị thế 0 cổ phiếu.

## Dự báo 20 phiên

- Phương pháp: XGBoost direct quantile 5/10/20D + conformal calibration; toàn bộ horizon qua gate: chưa.
- P50 cuối kỳ 52.64 (-1.61%).
- P10/P90 cuối kỳ 41.22 / 64.64.
...
- Điều kiện phát hành tín hiệu: Cận dưới expected excess return -0.0757867083493764 (dự báo điểm 3.3972784876823425e-05) chưa vượt chi phí + margin 0.0100..
- Trung hạn chưa xấu, ngắn hạn yếu vì giá dưới SMA20.
- Xu hướng kỹ thuật nghiêng về: Tích cực.
- XGBoost ước tính xác suất giá đóng cửa phiên tới cao hơn giá mở cửa: 47.9%.
- Mô hình Logistic đối chứng: 46.6%.
- Quantile forecast ước tính xác suất return cuối kỳ dương từ residual frozen holdout: 22.6%.
- Mức dừng lỗ tham chiếu 52.42, mục tiêu 1 56.70, tỷ lệ lợi nhuận/rủi ro 2.17.
...
- Góc nhìn kỹ thuật: Artifact kỹ thuật: bias Tích cực; điểm 5. Chi tiết artifact: Xu hướng: Trung tính (Giá trên SMA60 nhưng chưa vượt SMA20.); MACD: Tích cực (MACD trên signal, histogram dương.); RSI14: Tích cực (RSI 57.9.); Bollinger: Ổn định (Giá nằm trong dải Bollinger.); ADX: Xu hướng tăng (ADX 28.0, +DI vượt -DI.); Thanh khoản: Bình thường (1.39 lần trung bình.); Stochastic: Yếu lại (%K nằm dưới %D.)
- Góc nhìn cơ bản: Artifact cơ bản: Bưu chính Viettel; kỳ 2026-Q2; P/E 24.03; P/B 4.67; ROE 18.5%; ROA 4.8%; Debt/Equity 2.48; Revenue Growth 9.8%; Profit Growth -24.8%.
- Tin doanh nghiệp: Không có snapshot tin đã lưu; không đưa ra nhận định tin tức.
- Live research: Live snapshot lấy lúc 2026-08-16T06:35:06.707984+00:00; News Reader đọc được 0 bài. ML có 8 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.0757867083493764 (dự báo điểm 3.3972784876823425e-05) chưa vượt chi phí + margin 0.0100.
...
- ML guard: Cận dưới expected excess return -0.0757867083493764 (dự báo điểm 3.3972784876823425e-05) chưa vượt chi phí + margin 0.0100.
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/VTP/2026-08-16_13-34-54/all_files/symbol_news_model`
- Số bài tin trong CSV cho mã: 1
- Số dòng giá có news feature: 3
- XGBoost probability mới nhất: 0.501
- AUC OOS: 0.540
