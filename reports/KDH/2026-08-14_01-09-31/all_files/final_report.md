# Báo cáo ngày 2026-08-14 - KDH

## Tổng quan

- Dữ liệu: 2010-02-01 -> 2026-08-13, 4,120 phiên.
- Giá đóng cửa: 17.75 nghìn VND/cp.
...
- SMA20 17.75; SMA60 20.65; RSI14 38.1.
- MACD -0.577; đường tín hiệu -0.791; biểu đồ cột 0.214.
- ATR14 0.57; ATR% 3.2%; ADX14 39.8.
...
- XGBoost: độ chính xác cân bằng 0.499; AUC 0.493; log-loss 0.694.
- Mô hình Logistic đối chứng: độ chính xác cân bằng 0.499; AUC 0.496.
...
- Mức độ quan trọng của đặc trưng: return_1d=13.85; close_vs_sma20=12.75; return_5d=12.27; return_3d=11.29; adx_14=9.96; return_2d=9.79.

## Quản trị rủi ro

- Vốn tham chiếu 100,000,000 VND; rủi ro mỗi lệnh 1.0%.
- Mức dừng lỗ 16.89; mục tiêu 1 20.18; mục tiêu 2 20.18.
- Tỷ lệ lợi nhuận/rủi ro 2.47; khối lượng vị thế 0 cổ phiếu.

## Dự báo 20 phiên

- Phương pháp: XGBoost direct quantile 5/10/20D + conformal calibration; toàn bộ horizon qua gate: chưa.
- P50 cuối kỳ 17.65 (-0.54%).
- P10/P90 cuối kỳ 15.95 / 20.18.
...
- Điều kiện phát hành tín hiệu: Cận dưới expected excess return -0.03161767972214702 (dự báo điểm 0.0023235948756337166) chưa vượt chi phí + margin 0.0075..
...
- Mức dừng lỗ tham chiếu 16.89, mục tiêu 1 20.18, tỷ lệ lợi nhuận/rủi ro 2.47.
...
- Tóm tắt: ML decision hiện giữ nguyên NO_EDGE. News Reader đã trích đoạn có nguồn của 1 bài để phân loại chủ đề (co_tuc_va_hanh_dong_doanh_nghiep: 1, rui_ro: 1), nhưng các trích đoạn này không tạo bằng chứng mới cho quyết định đầu tư.
- Góc nhìn kỹ thuật: Artifact kỹ thuật: bias Suy yếu / cẩn thận; điểm -3. Chi tiết artifact: Xu hướng: Cẩn thận (Giá nằm dưới SMA60.); MACD: Tích cực (MACD trên signal, histogram dương.); RSI14: Yếu (RSI 38.1.); Bollinger: Ổn định (Giá nằm trong dải Bollinger.); ADX: Xu hướng giảm (ADX 39.8, -DI vượt +DI.); Thanh khoản: Bình thường (1.12 lần trung bình.); Stochastic: Yếu lại (%K nằm dưới %D.)
- Góc nhìn cơ bản: Artifact cơ bản: Nhà Khang Điền; kỳ 2026-Q2; P/E 11.59; P/B 1.09; ROE 9.5%; ROA 4.8%; Debt/Equity 0.98; Revenue Growth -84.7%; Profit Growth 276.7%.
- Tin doanh nghiệp: Đã đọc trích đoạn giới hạn của 1 bài; phân nhóm rule-based: co_tuc_va_hanh_dong_doanh_nghiep: 1, rui_ro: 1. Tác động cần kiểm chứng: Kiểm tra ngày GDKHQ, tỷ lệ, nguồn chi trả và nguy cơ pha loãng trước khi đánh giá tác động. Xác minh công bố chính thức, phạm vi ảnh hưởng và khả năng định lượng rủi ro. Đây không phải sentiment hay dự báo tác động giá.
- Live research: Live snapshot lấy lúc 2026-08-13T18:09:50.342046+00:00; News Reader đọc được 1 bài. ML có 8 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.03161767972214702 (dự báo điểm 0.0023235948756337166) chưa vượt chi phí + margin 0.0075.
...
- ML guard: Cận dưới expected excess return -0.03161767972214702 (dự báo điểm 0.0023235948756337166) chưa vượt chi phí + margin 0.0075.
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/KDH/2026-08-14_01-09-31/all_files/symbol_news_model`
