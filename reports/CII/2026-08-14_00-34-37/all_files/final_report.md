...
- Xác suất XGBoost để giá đóng cửa phiên tới cao hơn giá mở cửa: 61.4%.
...
- SMA20 13.82; SMA60 16.01; RSI14 42.2.
- MACD -0.495; đường tín hiệu -0.678; biểu đồ cột 0.183.
- ATR14 0.62; ATR% 4.4%; ADX14 31.9.
...
- ROE: 1.2%.
- ROA: 0.3%.
- Market cap: 9,542.2 tỷ.
- Revenue Growth: 2.9%.
- Profit Growth: -57.8%.
- P/E 83.00: định giá cao, cần tăng trưởng lợi nhuận hỗ trợ.
...
- Bài mới nhất: 2026-07-30T08:46:19+00:00.
...
- XGBoost: độ chính xác cân bằng 0.510; AUC 0.565; log-loss 0.682.
- Mô hình Logistic đối chứng: độ chính xác cân bằng 0.523; AUC 0.519.
...
- Mức độ quan trọng của đặc trưng: day_of_week=10.67; return_2d=10.29; adx_14=10.09; return_20d=9.96; macd_pct=9.90; return_1d=9.71.

## Quản trị rủi ro

- Vốn tham chiếu 100,000,000 VND; rủi ro mỗi lệnh 1.0%.
- Mức dừng lỗ 12.97; mục tiêu 1 16.05; mục tiêu 2 16.78.
- Tỷ lệ lợi nhuận/rủi ro 2.09; khối lượng vị thế 0 cổ phiếu.

## Dự báo 20 phiên

- Phương pháp: XGBoost direct quantile 5/10/20D + conformal calibration; toàn bộ horizon qua gate: chưa.
- P50 cuối kỳ 14.19 (2.07%).
- P10/P90 cuối kỳ 11.84 / 16.78.
...
- Điều kiện phát hành tín hiệu: Cận dưới expected excess return -0.05028556320676214 (dự báo điểm -0.0015927962958812714) chưa vượt chi phí + margin 0.0100..
- Điều kiện phát hành tín hiệu: Technical score -3 < 2..
- Xu hướng yếu: giá dưới SMA60, ưu tiên quản trị rủi ro.
- Xu hướng kỹ thuật nghiêng về: Suy yếu / cẩn thận.
- XGBoost ước tính xác suất giá đóng cửa phiên tới cao hơn giá mở cửa: 61.4%.
- Mô hình Logistic đối chứng: 55.9%.
- Quantile forecast ước tính xác suất return cuối kỳ dương từ residual frozen holdout: 54.8%.
- Mức dừng lỗ tham chiếu 12.97, mục tiêu 1 16.05, tỷ lệ lợi nhuận/rủi ro 2.09.
...
- Góc nhìn kỹ thuật: Artifact kỹ thuật: bias Suy yếu / cẩn thận; điểm -3. Chi tiết artifact: Xu hướng: Cẩn thận (Giá nằm dưới SMA60.); MACD: Tích cực (MACD trên signal, histogram dương.); RSI14: Yếu (RSI 42.2.); Bollinger: Ổn định (Giá nằm trong dải Bollinger.); ADX: Xu hướng giảm (ADX 31.9, -DI vượt +DI.); Thanh khoản: Bình thường (1.01 lần trung bình.); Stochastic: Yếu lại (%K nằm dưới %D.)
- Góc nhìn cơ bản: Artifact cơ bản: Hạ tầng Kỹ thuật TP.HCM; kỳ 2026-Q2; P/E 83.00; P/B 0.99; ROE 1.2%; ROA 0.3%; Debt/Equity 2.36; Revenue Growth 2.9%; Profit Growth -57.8%.
- Tin doanh nghiệp: Không có snapshot tin đã lưu; không đưa ra nhận định tin tức.
- Live research: Live snapshot lấy lúc 2026-08-13T17:35:04.049488+00:00; News Reader đọc được 0 bài. ML có 8 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.05028556320676214 (dự báo điểm -0.0015927962958812714) chưa vượt chi phí + margin 0.0100.
...
- ML guard: Cận dưới expected excess return -0.05028556320676214 (dự báo điểm -0.0015927962958812714) chưa vượt chi phí + margin 0.0100.
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/CII/2026-08-14_00-34-37/all_files/symbol_news_model`
- Số bài tin trong CSV cho mã: 0
- Số dòng giá có news feature: 0
- XGBoost probability mới nhất: 0.596
- AUC OOS: 0.557
- Balanced accuracy OOS: 0.502
- Backtest total return: 0.000
- Base XGBoost probability: 0.614
