# Báo cáo ngày 2026-08-16 - SSI

## Tổng quan

- Dữ liệu: 2008-03-10 -> 2026-08-14, 4,595 phiên.
- Giá đóng cửa: 24.50 nghìn VND/cp.
- Xu hướng kỹ thuật nghiêng về: Trung tính (điểm 0).
- Xác suất XGBoost để giá đóng cửa phiên tới cao hơn giá mở cửa: 54.6%.
...
- SMA20 23.90; SMA60 25.82; RSI14 47.9.
- MACD -0.111; đường tín hiệu -0.344; biểu đồ cột 0.233.
- ATR14 0.75; ATR% 3.0%; ADX14 24.8.
- Xu hướng: Cẩn thận - Giá nằm dưới SMA60.
- MACD: Tích cực - MACD trên signal, histogram dương.
- RSI14: Trung tính - RSI 47.9.
- Bollinger: Ổn định - Giá nằm trong dải Bollinger.
- ADX: Đi ngang - ADX 24.8.
- Thanh khoản: Bình thường - 1.49 lần trung bình.
...
- ROE: 13.4%.
- ROA: 5.0%.
- Market cap: 61,276.9 tỷ.
- Revenue Growth: 10.9%.
- Profit Growth: 27.0%.
- P/E 11.42: cần so sánh thêm với doanh nghiệp cùng ngành.
...
- Mô hình Logistic đối chứng: độ chính xác cân bằng 0.540; AUC 0.549.
...
- Mức độ quan trọng của đặc trưng: beta_60d=14.53; volatility_20d=14.24; volume_z_20=13.98; stoch_k_14=13.02; corr_60d=12.75; return_1d=12.64.

## Quản trị rủi ro

- Vốn tham chiếu 100,000,000 VND; rủi ro mỗi lệnh 1.0%.
- Mức dừng lỗ 23.38; mục tiêu 1 27.26; mục tiêu 2 27.26.
- Tỷ lệ lợi nhuận/rủi ro 2.12; khối lượng vị thế 0 cổ phiếu.

## Dự báo 20 phiên

- Phương pháp: XGBoost direct quantile 5/10/20D + conformal calibration; toàn bộ horizon qua gate: chưa.
- P50 cuối kỳ 24.08 (-1.70%).
- P10/P90 cuối kỳ 21.52 / 27.26.
...
- Điều kiện phát hành tín hiệu: Cận dưới expected excess return -0.03914879958262052 (dự báo điểm -0.003520115977153182) chưa vượt chi phí + margin 0.0100..
- Điều kiện phát hành tín hiệu: Technical score 0 < 2..
- Xu hướng yếu: giá dưới SMA60, ưu tiên quản trị rủi ro.
- Xu hướng kỹ thuật nghiêng về: Trung tính.
- XGBoost ước tính xác suất giá đóng cửa phiên tới cao hơn giá mở cửa: 54.6%.
- Mô hình Logistic đối chứng: 57.7%.
- Quantile forecast ước tính xác suất return cuối kỳ dương từ residual frozen holdout: 34.5%.
- Mức dừng lỗ tham chiếu 23.38, mục tiêu 1 27.26, tỷ lệ lợi nhuận/rủi ro 2.12.
...
- Tóm tắt: ML decision hiện giữ nguyên NO_EDGE. News Reader đã trích đoạn có nguồn của 4 bài để phân loại chủ đề (ket_qua_kinh_doanh: 3, co_tuc_va_hanh_dong_doanh_nghiep: 2, vi_mo: 2, nganh: 1, rui_ro: 1), nhưng các trích đoạn này không tạo bằng chứng mới cho quyết định đầu tư.
- Góc nhìn kỹ thuật: Artifact kỹ thuật: bias Trung tính; điểm 0. Chi tiết artifact: Xu hướng: Cẩn thận (Giá nằm dưới SMA60.); MACD: Tích cực (MACD trên signal, histogram dương.); RSI14: Trung tính (RSI 47.9.); Bollinger: Ổn định (Giá nằm trong dải Bollinger.); ADX: Đi ngang (ADX 24.8.); Thanh khoản: Bình thường (1.49 lần trung bình.); Stochastic: Yếu lại (%K nằm dưới %D.)
- Góc nhìn cơ bản: Artifact cơ bản: Chứng khoán SSI; kỳ 2026-Q2; P/E 11.42; P/B 1.51; ROE 13.4%; ROA 5.0%; Debt/Equity 1.37; Revenue Growth 10.9%; Profit Growth 27.0%.
...
- Live research: Live snapshot lấy lúc 2026-08-16T06:18:21.509105+00:00; News Reader đọc được 4 bài. ML có 5 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.03914879958262052 (dự báo điểm -0.003520115977153182) chưa vượt chi phí + margin 0.0100.
...
- News Reader [baodautu]: Chứng khoán phiên 13/8: Cổ phiếu ngân hàng - chứng khoán đột ngột lao dốc - baodautu | nhóm: ket_qua_kinh_doanh, vi_mo, nganh, rui_ro (2026-08-13T09:14:00+00:00)
...
- ML guard: Cận dưới expected excess return -0.03914879958262052 (dự báo điểm -0.003520115977153182) chưa vượt chi phí + margin 0.0100.
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/SSI/2026-08-16_13-18-05/all_files/symbol_news_model`
...
- Base XGBoost probability: 0.546
