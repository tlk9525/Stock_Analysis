...
- Góc nhìn kỹ thuật: Artifact kỹ thuật: bias Hồi phục / nghiêng tăng; điểm 4. Chi tiết artifact: Xu hướng: Trung tính (Giá trên SMA60 nhưng chưa vượt SMA20.); MACD: Tích cực (MACD trên signal, histogram dương.); RSI14: Trung tính (RSI 52.7.); Bollinger: Ổn định (Giá nằm trong dải Bollinger.); ADX: Xu hướng tăng (ADX 36.1, +DI vượt -DI.); Thanh khoản: Bình thường (0.71 lần trung bình.); Stochastic: Yếu lại (%K nằm dưới %D.)
- Góc nhìn cơ bản: Artifact cơ bản: Đầu tư Sài Gòn VRG; kỳ 2026-Q2; P/E 8.44; P/B 2.50; ROE 27.9%; ROA 4.9%; Debt/Equity 4.60; Revenue Growth 12.8%; Profit Growth 45.2%.
- Tin doanh nghiệp: Không có snapshot tin đã lưu; không đưa ra nhận định tin tức.
- Live research: Live snapshot lấy lúc 2026-08-16T06:16:22.621792+00:00; News Reader đọc được 0 bài. ML có 7 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.05437820625369072 (dự báo điểm 0.00219261203892529) chưa vượt chi phí + margin 0.0075.
...
- ML guard: Cận dưới expected excess return -0.05437820625369072 (dự báo điểm 0.00219261203892529) chưa vượt chi phí + margin 0.0075.
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/SIP/2026-08-16_13-16-10/all_files/symbol_news_model`
...
- Base XGBoost probability: 0.435
- Chênh lệch News-adjusted - Base: +0.045
