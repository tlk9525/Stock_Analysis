...
- Tóm tắt: ML decision hiện giữ nguyên NO_EDGE. News Reader đã trích đoạn có nguồn của 2 bài để phân loại chủ đề (ket_qua_kinh_doanh: 1, vi_mo: 1, nganh: 1), nhưng các trích đoạn này không tạo bằng chứng mới cho quyết định đầu tư.
- Góc nhìn kỹ thuật: Artifact kỹ thuật: bias Suy yếu / cẩn thận; điểm -3. Chi tiết artifact: Xu hướng: Cẩn thận (Giá nằm dưới SMA60.); MACD: Tích cực (MACD trên signal, histogram dương.); RSI14: Yếu (RSI 43.8.); Bollinger: Ổn định (Giá nằm trong dải Bollinger.); ADX: Xu hướng giảm (ADX 26.1, -DI vượt +DI.); Thanh khoản: Bình thường (1.04 lần trung bình.); Stochastic: Yếu lại (%K nằm dưới %D.)
- Góc nhìn cơ bản: Artifact cơ bản: Đạm Cà Mau; kỳ 2026-Q2; P/E 6.34; P/B 1.45; ROE 23.7%; ROA 14.0%; Debt/Equity 0.90; Revenue Growth 11.2%; Profit Growth 35.9%.
...
- Live research: Live snapshot lấy lúc 2026-08-13T17:42:09.747848+00:00; News Reader đọc được 2 bài. ML có 6 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.03978004062243623 (dự báo điểm 0.001302137621678412) chưa vượt chi phí + margin 0.0100.
- ML decision artifact: NO_EDGE. Technical score -3 < 2.
- News Reader [VOV.VN]: Một số cổ phiếu cần quan tâm 11/8: Cơ hội tiềm năng với ELC và DCM - VOV.VN | nhóm: ket_qua_kinh_doanh, vi_mo, nganh (2026-08-10T22:00:00+00:00)
- News Reader [VietstockFinance]: DCM: Khuyến nghị KHẢ QUAN với giá mục tiêu 36,650 đồng/cổ phiếu - VietstockFinance | nhóm: khác (2026-08-07T08:49:18+00:00)
...
- ML guard: Cận dưới expected excess return -0.03978004062243623 (dự báo điểm 0.001302137621678412) chưa vượt chi phí + margin 0.0100.
...
- [VOV.VN] Một số cổ phiếu cần quan tâm 11/8: Cơ hội tiềm năng với ELC và DCM - VOV.VN (2026-08-10T22:00:00+00:00): https://vov.vn/thi-truong/mot-so-co-phieu-can-quan-tam-118-co-hoi-tiem-nang-voi-elc-va-dcm-post1322897.vov
- [VietstockFinance] DCM: Khuyến nghị KHẢ QUAN với giá mục tiêu 36,650 đồng/cổ phiếu - VietstockFinance (2026-08-07T08:49:18+00:00): https://finance.vietstock.vn/bao-cao-phan-tich/21365/dcm-khuyen-nghi-kha-quan-voi-gia-muc-tieu-36650-dongco-phieu.htm?languageid=2
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/DCM/2026-08-14_00-41-50/all_files/symbol_news_model`
- Số bài tin trong CSV cho mã: 2
- Số dòng giá có news feature: 4
- XGBoost probability mới nhất: 0.551
- AUC OOS: 0.547
- Balanced accuracy OOS: 0.527
- Backtest total return: 0.000
- Base XGBoost probability: 0.560
