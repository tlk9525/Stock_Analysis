...
- Dữ liệu: 2008-03-05 -> 2026-08-05, 4,593 phiên.
- Giá đóng cửa: 22.45 nghìn VND/cp.
...
- SMA20 22.65; SMA60 22.09; RSI14 49.5.
- MACD -0.021; đường tín hiệu 0.041; biểu đồ cột -0.062.
- ATR14 0.54; ATR% 2.4%; ADX14 24.1.
...
- Kiểm thử: 2023-11-20 -> 2026-08-04.
- XGBoost: độ chính xác cân bằng 0.511; AUC 0.521; log-loss 0.690.
- Mô hình Logistic đối chứng: độ chính xác cân bằng 0.500; AUC 0.526.
...
- Mức độ quan trọng của đặc trưng: market_return_1d=12.68; relative_strength_20d=12.60; return_1d=11.37; bb_position_20=10.78; return_2d=10.69; beta_60d=10.56.

## Quản trị rủi ro

- Vốn tham chiếu 100,000,000 VND; rủi ro mỗi lệnh 1.0%.
- Mức dừng lỗ 21.87; mục tiêu 1 23.85; mục tiêu 2 24.54.
- Tỷ lệ lợi nhuận/rủi ro 1.85; khối lượng vị thế 0 cổ phiếu.

## Dự báo 20 phiên

- P50 cuối kỳ 22.24 (-0.94%).
- P10/P90 cuối kỳ 20.57 / 24.54.
...
- Điều kiện phát hành tín hiệu: XGBoost chưa vượt logistic baseline: AUC XGBoost=0.5213004280120208, AUC logistic=0.5264638921773973.
- Điều kiện phát hành tín hiệu: Probability 50.1% < 55.0%.
- Điều kiện phát hành tín hiệu: Technical score -3 < 2.
- Điều kiện phát hành tín hiệu: Lợi thế OOS ròng không đạt: return=-0.10245695999999993, Sharpe=-0.6011123891230747.
...
- Mức dừng lỗ tham chiếu 21.87, mục tiêu 1 23.85, tỷ lệ lợi nhuận/rủi ro 1.85.
