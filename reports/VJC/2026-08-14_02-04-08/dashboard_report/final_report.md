# Báo cáo ngày 2026-08-14 - VJC

## Tổng quan

- Dữ liệu: 2017-02-28 -> 2026-08-13, 2,363 phiên.
- Giá đóng cửa: 124.90 nghìn VND/cp.
- Xu hướng kỹ thuật nghiêng về: Suy yếu / cẩn thận (điểm -3).
- Xác suất XGBoost để giá đóng cửa phiên tới cao hơn giá mở cửa: 61.5%.
...
- SMA20 126.76; SMA60 133.41; RSI14 39.0.
- MACD -2.086; đường tín hiệu -2.466; biểu đồ cột 0.380.
- ATR14 3.23; ATR% 2.6%; ADX14 30.0.
- Xu hướng: Cẩn thận - Giá nằm dưới SMA60.
- MACD: Tích cực - MACD trên signal, histogram dương.
- RSI14: Yếu - RSI 39.0.
- Bollinger: Ổn định - Giá nằm trong dải Bollinger.
- ADX: Xu hướng giảm - ADX 30.0, -DI vượt +DI.
...
- ROE: 8.6%.
- ROA: 1.6%.
- Market cap: 98,213.2 tỷ.
- Revenue Growth: 70.5%.
- Profit Growth: -48.8%.
- P/E 45.12: định giá cao, cần tăng trưởng lợi nhuận hỗ trợ.
...
- XGBoost: độ chính xác cân bằng 0.535; AUC 0.537; log-loss 0.690.
- Mô hình Logistic đối chứng: độ chính xác cân bằng 0.503; AUC 0.543.
...
- Mức độ quan trọng của đặc trưng: market_return_1d=10.59; return_10d=9.43; bb_position_20=9.43; volume_ratio_20=9.22; market_volatility_20d=8.84; market_return_20d=8.53.

## Quản trị rủi ro

- Vốn tham chiếu 100,000,000 VND; rủi ro mỗi lệnh 1.0%.
- Mức dừng lỗ 120.05; mục tiêu 1 134.60; mục tiêu 2 138.62.
- Tỷ lệ lợi nhuận/rủi ro 1.66; khối lượng vị thế 0 cổ phiếu.

## Dự báo 20 phiên

- Phương pháp: XGBoost direct quantile 5/10/20D + conformal calibration; toàn bộ horizon qua gate: chưa.
- P50 cuối kỳ 124.88 (-0.01%).
- P10/P90 cuối kỳ 114.28 / 138.62.
...
- Điều kiện phát hành tín hiệu: Cận dưới expected excess return -0.03500616876332319 (dự báo điểm 0.0012185595696792006) chưa vượt chi phí + margin 0.0100..
- Điều kiện phát hành tín hiệu: Technical score -3 < 2..
- Xu hướng yếu: giá dưới SMA60, ưu tiên quản trị rủi ro.
- Xu hướng kỹ thuật nghiêng về: Suy yếu / cẩn thận.
- XGBoost ước tính xác suất giá đóng cửa phiên tới cao hơn giá mở cửa: 61.5%.
- Mô hình Logistic đối chứng: 60.3%.
- Quantile forecast ước tính xác suất return cuối kỳ dương từ residual frozen holdout: 54.8%.
- Mức dừng lỗ tham chiếu 120.05, mục tiêu 1 134.60, tỷ lệ lợi nhuận/rủi ro 1.66.
...
- Góc nhìn kỹ thuật: Artifact kỹ thuật: bias Suy yếu / cẩn thận; điểm -3. Chi tiết artifact: Xu hướng: Cẩn thận (Giá nằm dưới SMA60.); MACD: Tích cực (MACD trên signal, histogram dương.); RSI14: Yếu (RSI 39.0.); Bollinger: Ổn định (Giá nằm trong dải Bollinger.); ADX: Xu hướng giảm (ADX 30.0, -DI vượt +DI.); Thanh khoản: Bình thường (1.24 lần trung bình.); Stochastic: Yếu lại (%K nằm dưới %D.)
- Góc nhìn cơ bản: Artifact cơ bản: Vietjet Air; kỳ 2026-Q2; P/E 45.12; P/B 3.73; ROE 8.6%; ROA 1.6%; Debt/Equity 4.65; Revenue Growth 70.5%; Profit Growth -48.8%.
- Tin doanh nghiệp: Không có snapshot tin đã lưu; không đưa ra nhận định tin tức.
- Live research: Live snapshot lấy lúc 2026-08-13T19:04:26.234424+00:00; News Reader đọc được 0 bài. ML có 8 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.03500616876332319 (dự báo điểm 0.0012185595696792006) chưa vượt chi phí + margin 0.0100.
...
- ML guard: Cận dưới expected excess return -0.03500616876332319 (dự báo điểm 0.0012185595696792006) chưa vượt chi phí + margin 0.0100.
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/VJC/2026-08-14_02-04-08/all_files/symbol_news_model`
...
- Base XGBoost probability: 0.615
