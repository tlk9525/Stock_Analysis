# Báo cáo ngày 2026-08-16 - VRE

## Tổng quan

- Dữ liệu: 2017-11-06 -> 2026-08-14, 2,186 phiên.
- Giá đóng cửa: 23.95 nghìn VND/cp.
...
- SMA20 23.99; SMA60 26.89; RSI14 42.3.
- MACD -0.257; đường tín hiệu -0.443; biểu đồ cột 0.186.
- ATR14 1.00; ATR% 4.2%; ADX14 25.5.
- Xu hướng: Cẩn thận - Giá nằm dưới SMA60.
- MACD: Tích cực - MACD trên signal, histogram dương.
- RSI14: Yếu - RSI 42.3.
- Bollinger: Ổn định - Giá nằm trong dải Bollinger.
- ADX: Xu hướng giảm - ADX 25.5, -DI vượt +DI.
- Thanh khoản: Bình thường - 1.30 lần trung bình.
- Stochastic: Yếu lại - %K nằm dưới %D.

## Phân tích cơ bản

- Doanh nghiệp: Vincom Retail.
- Ngành: Real Estate.
...
- Current ratio 1.61: thanh khoản ngắn hạn khá.
- Revenue Growth 10.8% YoY.
- Profit Growth 30.4% YoY.
- CFO/LNST 1.13: chất lượng chuyển đổi lợi nhuận sang tiền mặt khá tốt.
...
- Bài mới nhất: 2026-08-06T03:27:16+00:00.
...
- XGBoost: độ chính xác cân bằng 0.523; AUC 0.515; log-loss 0.693.
- Mô hình Logistic đối chứng: độ chính xác cân bằng 0.529; AUC 0.544.
- Mô hình đa số đối chứng: độ chính xác cân bằng 0.500.
- Vòng boosting tốt nhất: 28.
...
- Mức độ quan trọng của đặc trưng: macd_pct=10.65; market_return_1d=10.49; market_return_20d=9.87; adx_14=9.06; market_volatility_20d=8.95; close_vs_sma60=8.91.

## Quản trị rủi ro

- Vốn tham chiếu 100,000,000 VND; rủi ro mỗi lệnh 1.0%.
- Mức dừng lỗ 22.45; mục tiêu 1 26.80; mục tiêu 2 28.96.
- Tỷ lệ lợi nhuận/rủi ro 1.68; khối lượng vị thế 0 cổ phiếu.

## Dự báo 20 phiên

- Phương pháp: XGBoost direct quantile 5/10/20D + conformal calibration; toàn bộ horizon qua gate: chưa.
- P50 cuối kỳ 23.61 (-1.40%).
- P10/P90 cuối kỳ 19.26 / 28.96.
...
- Điều kiện phát hành tín hiệu: Cận dưới expected excess return -0.045747059122013156 (dự báo điểm -0.0034080534242093563) chưa vượt chi phí + margin 0.0100..
...
- Mức dừng lỗ tham chiếu 22.45, mục tiêu 1 26.80, tỷ lệ lợi nhuận/rủi ro 1.68.
...
- Góc nhìn kỹ thuật: Artifact kỹ thuật: bias Suy yếu / cẩn thận; điểm -3. Chi tiết artifact: Xu hướng: Cẩn thận (Giá nằm dưới SMA60.); MACD: Tích cực (MACD trên signal, histogram dương.); RSI14: Yếu (RSI 42.3.); Bollinger: Ổn định (Giá nằm trong dải Bollinger.); ADX: Xu hướng giảm (ADX 25.5, -DI vượt +DI.); Thanh khoản: Bình thường (1.30 lần trung bình.); Stochastic: Yếu lại (%K nằm dưới %D.)
- Góc nhìn cơ bản: Artifact cơ bản: Vincom Retail; kỳ 2026-Q2; P/E 7.51; P/B 1.10; ROE 15.0%; ROA 11.8%; Debt/Equity 0.27; Revenue Growth 10.8%; Profit Growth 30.4%.
- Tin doanh nghiệp: Không có snapshot tin đã lưu; không đưa ra nhận định tin tức.
- Live research: Live snapshot lấy lúc 2026-08-16T06:33:58.852035+00:00; News Reader đọc được 0 bài. ML có 5 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.045747059122013156 (dự báo điểm -0.0034080534242093563) chưa vượt chi phí + margin 0.0100.
...
- ML guard: Cận dưới expected excess return -0.045747059122013156 (dự báo điểm -0.0034080534242093563) chưa vượt chi phí + margin 0.0100.
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/VRE/2026-08-16_13-33-47/all_files/symbol_news_model`
- Số bài tin trong CSV cho mã: 0
- Số dòng giá có news feature: 0
- XGBoost probability mới nhất: 0.528
- AUC OOS: 0.531
- Balanced accuracy OOS: 0.531
