# Báo cáo ngày 2026-08-14 - PLX

## Tổng quan

- Dữ liệu: 2017-04-21 -> 2026-08-13, 2,326 phiên.
- Giá đóng cửa: 35.60 nghìn VND/cp.
...
- SMA20 33.61; SMA60 35.88; RSI14 54.9.
- MACD 0.378; đường tín hiệu -0.177; biểu đồ cột 0.555.
- ATR14 1.33; ATR% 3.7%; ADX14 23.9.
- Xu hướng: Cẩn thận - Giá nằm dưới SMA60.
- MACD: Tích cực - MACD trên signal, histogram dương.
- RSI14: Trung tính - RSI 54.9.
- Bollinger: Ổn định - Giá nằm trong dải Bollinger.
- ADX: Đi ngang - ADX 23.9.
...
- ROE: 12.5%.
- ROA: 3.5%.
- Market cap: 46,567.2 tỷ.
- Revenue Growth: 78.0%.
- Profit Growth: 105.6%.
- P/E 14.46: cần so sánh thêm với doanh nghiệp cùng ngành.
...
- Kiểm thử: 2023-08-03 -> 2026-08-12.
- XGBoost: độ chính xác cân bằng 0.505; AUC 0.513; log-loss 0.698.
- Mô hình Logistic đối chứng: độ chính xác cân bằng 0.517; AUC 0.480.
...
- Mức độ quan trọng của đặc trưng: return_2d=12.63; return_1d=10.12; volatility_20d=9.79; atr_pct_14=9.78; excess_return_1d=9.09; bb_position_20=9.07.

## Quản trị rủi ro

- Vốn tham chiếu 100,000,000 VND; rủi ro mỗi lệnh 1.0%.
- Mức dừng lỗ 35.52; mục tiêu 1 38.00; mục tiêu 2 41.00.
- Tỷ lệ lợi nhuận/rủi ro 8.72; khối lượng vị thế 0 cổ phiếu.

## Dự báo 20 phiên

- Phương pháp: XGBoost direct quantile 5/10/20D + conformal calibration; toàn bộ horizon qua gate: chưa.
- P50 cuối kỳ 35.13 (-1.32%).
- P10/P90 cuối kỳ 30.68 / 41.00.
...
- Điều kiện phát hành tín hiệu: Cận dưới expected excess return -0.036763342675105504 (dự báo điểm -0.0014404148096218705) chưa vượt chi phí + margin 0.0100..
...
- Quantile forecast ước tính xác suất return cuối kỳ dương từ residual frozen holdout: 36.5%.
- Mức dừng lỗ tham chiếu 35.52, mục tiêu 1 38.00, tỷ lệ lợi nhuận/rủi ro 8.72.
...
- Tóm tắt: ML decision hiện giữ nguyên NO_EDGE. News Reader đã trích đoạn có nguồn của 1 bài để phân loại chủ đề (ket_qua_kinh_doanh: 1, co_tuc_va_hanh_dong_doanh_nghiep: 1), nhưng các trích đoạn này không tạo bằng chứng mới cho quyết định đầu tư.
- Góc nhìn kỹ thuật: Artifact kỹ thuật: bias Trung tính; điểm 0. Chi tiết artifact: Xu hướng: Cẩn thận (Giá nằm dưới SMA60.); MACD: Tích cực (MACD trên signal, histogram dương.); RSI14: Trung tính (RSI 54.9.); Bollinger: Ổn định (Giá nằm trong dải Bollinger.); ADX: Đi ngang (ADX 23.9.); Thanh khoản: Bình thường (0.99 lần trung bình.); Stochastic: Yếu lại (%K nằm dưới %D.)
- Góc nhìn cơ bản: Artifact cơ bản: Petrolimex; kỳ 2026-Q2; P/E 14.46; P/B 1.81; ROE 12.5%; ROA 3.5%; Debt/Equity 2.01; Revenue Growth 78.0%; Profit Growth 105.6%.
...
- Live research: Live snapshot lấy lúc 2026-08-13T18:31:51.709974+00:00; News Reader đọc được 1 bài. ML có 10 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.036763342675105504 (dự báo điểm -0.0014404148096218705) chưa vượt chi phí + margin 0.0100.
...
- ML guard: Cận dưới expected excess return -0.036763342675105504 (dự báo điểm -0.0014404148096218705) chưa vượt chi phí + margin 0.0100.
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/PLX/2026-08-14_01-31-33/all_files/symbol_news_model`
- Số bài tin trong CSV cho mã: 7
- Số dòng giá có news feature: 4
- XGBoost probability mới nhất: 0.523
- AUC OOS: 0.489
