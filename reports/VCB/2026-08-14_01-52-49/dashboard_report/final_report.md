...
- Mức dừng lỗ 59.32; mục tiêu 1 61.00; mục tiêu 2 65.70.
- Tỷ lệ lợi nhuận/rủi ro 2.50; khối lượng vị thế 0 cổ phiếu.

## Dự báo 20 phiên

- Phương pháp: XGBoost direct quantile 5/10/20D + conformal calibration; toàn bộ horizon qua gate: chưa.
- P50 cuối kỳ 59.63 (0.22%).
- P10/P90 cuối kỳ 54.74 / 65.70.
...
- Điều kiện phát hành tín hiệu: Cận dưới expected excess return -0.026126440152226205 (dự báo điểm 0.0009368061437271535) chưa vượt chi phí + margin 0.0050..
...
- Live research: Live snapshot lấy lúc 2026-08-13T18:53:09.543623+00:00; News Reader đọc được 2 bài. ML có 4 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.026126440152226205 (dự báo điểm 0.0009368061437271535) chưa vượt chi phí + margin 0.0050.
...
- ML guard: Cận dưới expected excess return -0.026126440152226205 (dự báo điểm 0.0009368061437271535) chưa vượt chi phí + margin 0.0050.
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/VCB/2026-08-14_01-52-49/all_files/symbol_news_model`
