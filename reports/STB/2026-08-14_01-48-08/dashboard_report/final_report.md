...
- Góc nhìn kỹ thuật: Artifact kỹ thuật: bias Hồi phục / nghiêng tăng; điểm 3. Chi tiết artifact: Xu hướng: Tích cực (Giá nằm trên SMA20 và SMA60.); MACD: Tích cực (MACD trên signal, histogram dương.); RSI14: Trung tính (RSI 52.2.); Bollinger: Ổn định (Giá nằm trong dải Bollinger.); ADX: Đi ngang (ADX 15.0.); Thanh khoản: Thấp (0.62 lần trung bình.); Stochastic: Yếu lại (%K nằm dưới %D.)
- Góc nhìn cơ bản: Artifact cơ bản: NH Sài Gòn Tài Lộc (SACOMBANK); kỳ 2026-Q2; P/E 45.36; P/B 2.22; ROE 5.0%; ROA 0.4%; Debt/Equity 13.20; Revenue Growth 28.1%; Profit Growth -53.5%.
...
- Live research: Live snapshot lấy lúc 2026-08-13T18:48:32.242558+00:00; News Reader đọc được 2 bài. ML có 7 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.03612849407718177 (dự báo điểm -0.00045543364831246436) chưa vượt chi phí + margin 0.0100.
...
- ML guard: Cận dưới expected excess return -0.03612849407718177 (dự báo điểm -0.00045543364831246436) chưa vượt chi phí + margin 0.0100.
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/STB/2026-08-14_01-48-08/all_files/symbol_news_model`
