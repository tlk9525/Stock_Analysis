...
- Góc nhìn kỹ thuật: Artifact kỹ thuật: bias Hồi phục / nghiêng tăng; điểm 2. Chi tiết artifact: Xu hướng: Tích cực (Giá nằm trên SMA20 và SMA60.); MACD: Tích cực (MACD trên signal, histogram dương.); RSI14: Tích cực (RSI 61.6.); Bollinger: Ổn định (Giá nằm trong dải Bollinger.); ADX: Xu hướng giảm (ADX 31.3, -DI vượt +DI.); Thanh khoản: Thấp (0.41 lần trung bình.); Stochastic: Yếu lại (%K nằm dưới %D.)
- Góc nhìn cơ bản: Artifact cơ bản: Tập đoàn KIDO; kỳ 2026-Q2; P/E 30.06; P/B 2.44; ROE 7.6%; ROA 3.8%; Debt/Equity 0.96; Revenue Growth -7.3%; Profit Growth -105.8%.
...
- Live research: Live snapshot lấy lúc 2026-08-13T18:08:58.682949+00:00; News Reader đọc được 1 bài. ML có 5 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.03785301428313714 (dự báo điểm -0.001208605128340423) chưa vượt chi phí + margin 0.0100.
...
- ML guard: Cận dưới expected excess return -0.03785301428313714 (dự báo điểm -0.001208605128340423) chưa vượt chi phí + margin 0.0100.
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/KDC/2026-08-14_01-08-36/all_files/symbol_news_model`
- Số bài tin trong CSV cho mã: 1
- Số dòng giá có news feature: 0
- XGBoost probability mới nhất: 0.419
- AUC OOS: 0.520
- Balanced accuracy OOS: 0.494
- Backtest total return: 0.000
- Base XGBoost probability: 0.414
