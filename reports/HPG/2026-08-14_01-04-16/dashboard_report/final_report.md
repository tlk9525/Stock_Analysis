# Báo cáo ngày 2026-08-14 - HPG

## Tổng quan

- Dữ liệu: 2008-03-10 -> 2026-08-13, 4,594 phiên.
- Giá đóng cửa: 21.70 nghìn VND/cp.
- Xu hướng kỹ thuật nghiêng về: Suy yếu / cẩn thận (điểm -3).
- Xác suất XGBoost để giá đóng cửa phiên tới cao hơn giá mở cửa: 55.3%.
...
- SMA20 21.53; SMA60 22.85; RSI14 44.8.
- MACD -0.140; đường tín hiệu -0.252; biểu đồ cột 0.113.
- ATR14 0.52; ATR% 2.4%; ADX14 31.2.
...
- Mô hình Logistic đối chứng: độ chính xác cân bằng 0.517; AUC 0.566.
...
- Mức độ quan trọng của đặc trưng: adx_14=10.94; macd_pct=10.01; day_of_week=9.38; return_1d=9.37; macd_hist_pct=9.04; market_return_1d=9.03.

## Quản trị rủi ro

- Vốn tham chiếu 100,000,000 VND; rủi ro mỗi lệnh 1.0%.
- Mức dừng lỗ 20.92; mục tiêu 1 24.88; mục tiêu 2 24.88.
- Tỷ lệ lợi nhuận/rủi ro 3.45; khối lượng vị thế 0 cổ phiếu.

## Dự báo 20 phiên

- Phương pháp: XGBoost direct quantile 5/10/20D + conformal calibration; toàn bộ horizon qua gate: chưa.
- P50 cuối kỳ 21.96 (1.18%).
- P10/P90 cuối kỳ 19.50 / 24.88.
...
- Điều kiện phát hành tín hiệu: Cận dưới expected excess return -0.0303340310551643 (dự báo điểm 0.0011669197119772434) chưa vượt chi phí + margin 0.0100..
- Điều kiện phát hành tín hiệu: Technical score -3 < 2..
- Xu hướng yếu: giá dưới SMA60, ưu tiên quản trị rủi ro.
- Xu hướng kỹ thuật nghiêng về: Suy yếu / cẩn thận.
- XGBoost ước tính xác suất giá đóng cửa phiên tới cao hơn giá mở cửa: 55.3%.
- Mô hình Logistic đối chứng: 54.2%.
- Quantile forecast ước tính xác suất return cuối kỳ dương từ residual frozen holdout: 38.1%.
- Mức dừng lỗ tham chiếu 20.92, mục tiêu 1 24.88, tỷ lệ lợi nhuận/rủi ro 3.45.
...
- Live research: Live snapshot lấy lúc 2026-08-13T18:04:40.005711+00:00; News Reader đọc được 3 bài. ML có 8 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.0303340310551643 (dự báo điểm 0.0011669197119772434) chưa vượt chi phí + margin 0.0100.
...
- ML guard: Cận dưới expected excess return -0.0303340310551643 (dự báo điểm 0.0011669197119772434) chưa vượt chi phí + margin 0.0100.
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/HPG/2026-08-14_01-04-16/all_files/symbol_news_model`
- Số bài tin trong CSV cho mã: 10
- Số dòng giá có news feature: 7
- XGBoost probability mới nhất: 0.540
- AUC OOS: 0.575
- Balanced accuracy OOS: 0.514
- Backtest total return: 0.000
- Base XGBoost probability: 0.553
