# Báo cáo ngày 2026-08-14 - POW

## Tổng quan

- Dữ liệu: 2018-03-06 -> 2026-08-13, 2,101 phiên.
- Giá đóng cửa: 13.50 nghìn VND/cp.
...
- SMA20 13.59; SMA60 13.92; RSI14 44.8.
- MACD -0.082; đường tín hiệu -0.105; biểu đồ cột 0.023.
- ATR14 0.36; ATR% 2.7%; ADX14 28.1.
- Xu hướng: Cẩn thận - Giá nằm dưới SMA60.
- MACD: Tích cực - MACD trên signal, histogram dương.
- RSI14: Yếu - RSI 44.8.
- Bollinger: Ổn định - Giá nằm trong dải Bollinger.
- ADX: Xu hướng giảm - ADX 28.1, -DI vượt +DI.
...
- Bài mới nhất: 2026-08-12T09:55:43+00:00.
- Ghi chú dữ liệu: Sentiment hiện là keyword heuristic, chỉ phục vụ research/dashboard; cần tập gán nhãn tiếng Việt trước khi dùng cho model.
- Ghi chú dữ liệu: Chỉ bài có published_at/available_at mới đủ điều kiện tạo feature point-in-time.

## Mô hình XGBoost

- Kiểm thử: 2023-12-21 -> 2026-08-12.
- XGBoost: độ chính xác cân bằng 0.530; AUC 0.585; log-loss 0.672.
...
- Mức độ quan trọng của đặc trưng: return_1d=10.37; relative_strength_20d=9.54; stoch_k_14=9.40; return_2d=9.25; macd_hist_pct=8.98; atr_pct_14=8.80.

## Quản trị rủi ro

- Vốn tham chiếu 100,000,000 VND; rủi ro mỗi lệnh 1.0%.
- Mức dừng lỗ 12.96; mục tiêu 1 14.91; mục tiêu 2 14.91.
- Tỷ lệ lợi nhuận/rủi ro 2.20; khối lượng vị thế 0 cổ phiếu.

## Dự báo 20 phiên

- Phương pháp: XGBoost direct quantile 5/10/20D + conformal calibration; toàn bộ horizon qua gate: chưa.
- P50 cuối kỳ 13.67 (1.24%).
- P10/P90 cuối kỳ 12.67 / 14.91.
...
- Điều kiện phát hành tín hiệu: Cận dưới expected excess return -0.03894882613913453 (dự báo điểm -0.0012882235459983349) chưa vượt chi phí + margin 0.0100..
...
- Quantile forecast ước tính xác suất return cuối kỳ dương từ residual frozen holdout: 51.6%.
- Mức dừng lỗ tham chiếu 12.96, mục tiêu 1 14.91, tỷ lệ lợi nhuận/rủi ro 2.20.
...
- Tóm tắt: ML decision hiện giữ nguyên NO_EDGE. News Reader đã trích đoạn có nguồn của 2 bài để phân loại chủ đề (ket_qua_kinh_doanh: 2, co_tuc_va_hanh_dong_doanh_nghiep: 2, vi_mo: 2, nganh: 2), nhưng các trích đoạn này không tạo bằng chứng mới cho quyết định đầu tư.
- Góc nhìn kỹ thuật: Artifact kỹ thuật: bias Suy yếu / cẩn thận; điểm -3. Chi tiết artifact: Xu hướng: Cẩn thận (Giá nằm dưới SMA60.); MACD: Tích cực (MACD trên signal, histogram dương.); RSI14: Yếu (RSI 44.8.); Bollinger: Ổn định (Giá nằm trong dải Bollinger.); ADX: Xu hướng giảm (ADX 28.1, -DI vượt +DI.); Thanh khoản: Bình thường (0.97 lần trung bình.); Stochastic: Yếu lại (%K nằm dưới %D.)
...
- Tin doanh nghiệp: Đã đọc trích đoạn giới hạn của 2 bài; phân nhóm rule-based: ket_qua_kinh_doanh: 2, co_tuc_va_hanh_dong_doanh_nghiep: 2, vi_mo: 2, nganh: 2. Tác động cần kiểm chứng: Đối chiếu doanh thu/lợi nhuận trong bài với BCTC và kỳ vọng thị trường. Kiểm tra ngày GDKHQ, tỷ lệ, nguồn chi trả và nguy cơ pha loãng trước khi đánh giá tác động. Đối chiếu thời điểm công bố và kênh tác động lãi suất/tỷ giá với mô hình kinh doanh. So sánh tín hiệu ngành với thị phần, nhu cầu và đối thủ trước khi suy luận cho riêng doanh nghiệp. Đây không phải sentiment hay dự báo tác động giá.
- Live research: Live snapshot lấy lúc 2026-08-13T18:35:44.036474+00:00; News Reader đọc được 2 bài. ML có 10 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest. Final report dùng fallback grounded từ artifact local.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.03894882613913453 (dự báo điểm -0.0012882235459983349) chưa vượt chi phí + margin 0.0100.
- ML decision artifact: NO_EDGE. Technical score -3 < 2.
- News Reader [VietstockFinance]: POW: Khuyến nghị MUA với giá mục tiêu 18,400 đồng/cổ phiếu - VietstockFinance | nhóm: ket_qua_kinh_doanh, co_tuc_va_hanh_dong_doanh_nghiep, vi_mo, nganh (2026-08-10T04:22:58+00:00)
...
- ML guard: Cận dưới expected excess return -0.03894882613913453 (dự báo điểm -0.0012882235459983349) chưa vượt chi phí + margin 0.0100.
...
- [VietstockFinance] POW: Khuyến nghị MUA với giá mục tiêu 18,400 đồng/cổ phiếu - VietstockFinance (2026-08-10T04:22:58+00:00): https://finance.vietstock.vn/bao-cao-phan-tich/21403/pow-khuyen-nghi-mua-voi-gia-muc-tieu-18400-dongco-phieu.htm
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/POW/2026-08-14_01-34-41/all_files/symbol_news_model`
