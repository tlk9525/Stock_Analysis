...
- Góc nhìn kỹ thuật: Artifact kỹ thuật: bias Suy yếu / cẩn thận; điểm -2. Chi tiết artifact: Xu hướng: Cẩn thận (Giá nằm dưới SMA60.); MACD: Cẩn thận (MACD dưới signal, histogram âm.); RSI14: Yếu (RSI 43.5.); Bollinger: Ổn định (Giá nằm trong dải Bollinger.); ADX: Đi ngang (ADX 14.4.); Thanh khoản: Đột biến (1.92 lần trung bình.); Stochastic: Hồi phục (%K nằm trên %D.)
- Góc nhìn cơ bản: Artifact cơ bản: Đầu tư Văn Phú - Invest; kỳ 2026-Q2; P/E 47.78; P/B 3.54; ROE 7.6%; ROA 2.7%; Debt/Equity 1.77; Revenue Growth 373.5%; Profit Growth 3154.4%.
...
- Live research: Live snapshot lấy lúc 2026-08-13T19:08:31.680871+00:00; News Reader đọc được 1 bài. ML có 4 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.03384560917216084 (dự báo điểm 0.004687556531280279) chưa vượt chi phí + margin 0.0075.
- ML decision artifact: NO_EDGE. Technical score -2 < 2.
- News Reader [CÔNG TY CỔ PHẦN CHỨNG KHOÁN CV]: VPI: Văn Phú trả cổ tức bằng cổ phiếu tỷ lệ 10% - CÔNG TY CỔ PHẦN CHỨNG KHOÁN CV | nhóm: ket_qua_kinh_doanh, co_tuc_va_hanh_dong_doanh_nghiep (2026-08-07T14:48:43+00:00)
...
- ML guard: Cận dưới expected excess return -0.03384560917216084 (dự báo điểm 0.004687556531280279) chưa vượt chi phí + margin 0.0075.
...
- [CÔNG TY CỔ PHẦN CHỨNG KHOÁN CV] VPI: Văn Phú trả cổ tức bằng cổ phiếu tỷ lệ 10% - CÔNG TY CỔ PHẦN CHỨNG KHOÁN CV (2026-08-07T14:48:43+00:00): https://news.cvs.vn/vpi-van-phu-tra-co-tuc-bang-co-phieu-ty-le-10-48323
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/VPI/2026-08-14_02-08-13/all_files/symbol_news_model`
- Số bài tin trong CSV cho mã: 1
- Số dòng giá có news feature: 3
- XGBoost probability mới nhất: 0.567
- AUC OOS: 0.547
- Balanced accuracy OOS: 0.523
- Backtest total return: 0.000
- Base XGBoost probability: 0.608
