# Báo cáo ngày 2026-08-14 - BID

## Tổng quan

- Dữ liệu: 2014-01-24 -> 2026-08-13, 3,128 phiên.
- Giá đóng cửa: 38.85 nghìn VND/cp.
- Xu hướng kỹ thuật nghiêng về: Trung tính (điểm 0).
- Xác suất XGBoost để giá đóng cửa phiên tới cao hơn giá mở cửa: 44.1%.
...
- SMA20 37.44; SMA60 40.07; RSI14 52.2.
- MACD -0.105; đường tín hiệu -0.506; biểu đồ cột 0.401.
- ATR14 1.00; ATR% 2.6%; ADX14 23.5.
...
- Kiểm thử: 2023-10-09 -> 2026-08-12.
...
- Mức độ quan trọng của đặc trưng: return_1d=10.20; return_2d=9.90; day_of_week=9.60; corr_60d=9.04; month_of_year=8.53; range_pct=8.51.

## Quản trị rủi ro

- Vốn tham chiếu 100,000,000 VND; rủi ro mỗi lệnh 1.0%.
- Mức dừng lỗ 37.35; mục tiêu 1 42.00; mục tiêu 2 42.00.
- Tỷ lệ lợi nhuận/rủi ro 1.74; khối lượng vị thế 0 cổ phiếu.

## Dự báo 20 phiên

- Phương pháp: XGBoost direct quantile 5/10/20D + conformal calibration; toàn bộ horizon qua gate: chưa.
- P50 cuối kỳ 38.71 (-0.36%).
- P10/P90 cuối kỳ 36.36 / 42.00.
...
- Điều kiện phát hành tín hiệu: Cận dưới expected excess return -0.03132478597170807 (dự báo điểm -0.0004633689532056451) chưa vượt chi phí + margin 0.0100..
- Điều kiện phát hành tín hiệu: Technical score 0 < 2..
- Xu hướng yếu: giá dưới SMA60, ưu tiên quản trị rủi ro.
- Xu hướng kỹ thuật nghiêng về: Trung tính.
- XGBoost ước tính xác suất giá đóng cửa phiên tới cao hơn giá mở cửa: 44.1%.
- Mô hình Logistic đối chứng: 43.5%.
- Quantile forecast ước tính xác suất return cuối kỳ dương từ residual frozen holdout: 38.5%.
- Mức dừng lỗ tham chiếu 37.35, mục tiêu 1 42.00, tỷ lệ lợi nhuận/rủi ro 1.74.
...
- Tóm tắt: ML decision hiện giữ nguyên NO_EDGE. News Reader đã trích đoạn có nguồn của 2 bài để phân loại chủ đề (ket_qua_kinh_doanh: 1, co_tuc_va_hanh_dong_doanh_nghiep: 1, nganh: 1), nhưng các trích đoạn này không tạo bằng chứng mới cho quyết định đầu tư.
- Góc nhìn kỹ thuật: Artifact kỹ thuật: bias Trung tính; điểm 0. Chi tiết artifact: Xu hướng: Cẩn thận (Giá nằm dưới SMA60.); MACD: Tích cực (MACD trên signal, histogram dương.); RSI14: Trung tính (RSI 52.2.); Bollinger: Ổn định (Giá nằm trong dải Bollinger.); ADX: Đi ngang (ADX 23.5.); Thanh khoản: Bình thường (1.26 lần trung bình.); Stochastic: Yếu lại (%K nằm dưới %D.)
- Góc nhìn cơ bản: Artifact cơ bản: BIDV; kỳ 2026-Q2; P/E 8.63; P/B 1.48; ROE 17.7%; ROA 1.0%; Debt/Equity 16.31; Revenue Growth 7.0%; Profit Growth 20.6%.
- Tin doanh nghiệp: Đã đọc trích đoạn giới hạn của 2 bài; phân nhóm rule-based: ket_qua_kinh_doanh: 1, co_tuc_va_hanh_dong_doanh_nghiep: 1, nganh: 1. Tác động cần kiểm chứng: Đối chiếu doanh thu/lợi nhuận trong bài với BCTC và kỳ vọng thị trường. Kiểm tra ngày GDKHQ, tỷ lệ, nguồn chi trả và nguy cơ pha loãng trước khi đánh giá tác động. So sánh tín hiệu ngành với thị phần, nhu cầu và đối thủ trước khi suy luận cho riêng doanh nghiệp. Đây không phải sentiment hay dự báo tác động giá.
- Live research: Live snapshot lấy lúc 2026-08-13T17:29:09.647006+00:00; News Reader đọc được 2 bài. ML có 9 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest.
...
- ML decision artifact: NO_EDGE. Cận dưới expected excess return -0.03132478597170807 (dự báo điểm -0.0004633689532056451) chưa vượt chi phí + margin 0.0100.
...
- ML guard: Cận dưới expected excess return -0.03132478597170807 (dự báo điểm -0.0004633689532056451) chưa vượt chi phí + margin 0.0100.
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/BID/2026-08-14_00-28-50/all_files/symbol_news_model`
- Số bài tin trong CSV cho mã: 6
- Số dòng giá có news feature: 10
- XGBoost probability mới nhất: 0.449
- AUC OOS: 0.556
- Balanced accuracy OOS: 0.506
- Backtest total return: 0.000
- Base XGBoost probability: 0.441
