...
### Kịch bản giới hạn số vòng 10 / 5 / 1

| Kịch bản | Net sau phí | Diễn giải |
|---|---:|---|
| Giới hạn tối đa 10 vòng | +6.2% | Gross +11.6%; phí 5.0%; thực chạy 10 vòng; ngưỡng xác suất trong nhóm 66.3%; Sharpe 0.41. |
| Giới hạn tối đa 5 vòng | +10.2% | Gross +13.0%; phí 2.5%; thực chạy 5 vòng; ngưỡng xác suất trong nhóm 69.0%; Sharpe 0.70. |
| Giới hạn tối đa 1 vòng | +5.6% | Gross +6.1%; phí 0.5%; thực chạy 1 vòng; ngưỡng xác suất trong nhóm 75.2%; Sharpe 0.60. |
Ghi chú: bảng này giới hạn số vòng bằng cách ưu tiên các phiên có xác suất XGBoost cao hơn trong tập OOS; không phải chọn lệnh thắng sau khi biết kết quả và không tự biến NO_EDGE thành BUY.
...
- Live research: Live snapshot lấy lúc 2026-08-12T16:45:55.928994+00:00; News Reader đọc được 1 bài. ML có 4 lý do guard và vẫn là NO_EDGE. Không dùng tin live để train/backtest. Final report dùng fallback grounded từ artifact local.
...
- Symbol-news report: `/Users/tranlekhoa/Documents/DATA_SCI/vn_stock_analysis/reports/HCM/2026-08-12_23-45-36/all_files/symbol_news_model`
