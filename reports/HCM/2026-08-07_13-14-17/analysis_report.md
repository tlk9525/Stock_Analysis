...
- SMA20 25.10; SMA60 24.38; RSI14 55.2.
- MACD 0.309; đường tín hiệu 0.339; biểu đồ cột -0.031.
...
- ROE: 9.8%.
- ROA: 3.1%.
- Market cap: 34,356.1 tỷ.
- Revenue Growth: 15.1%.
- Profit Growth: 42.0%.
- P/E 19.30: cần so sánh thêm với doanh nghiệp cùng ngành.
- P/B 1.98: nên đọc cùng ROE và đặc thù ngành.
...
- Mức dừng lỗ 24.14; mục tiêu 1 28.84; mục tiêu 2 28.84.
- Tỷ lệ lợi nhuận/rủi ro 2.38; khối lượng vị thế 0 cổ phiếu.

## Dự báo 20 phiên

- P50 cuối kỳ 25.10 (-1.18%).
- P10/P90 cuối kỳ 22.08 / 28.84.
...
- Điều kiện phát hành tín hiệu: Probability 47.5% < 55.0%.
...
- Mô hình Logistic đối chứng: 39.9%.
- Monte Carlo ước tính xác suất kết thúc trên giá hiện tại: 45.5%.
- Mức dừng lỗ tham chiếu 24.14, mục tiêu 1 28.84, tỷ lệ lợi nhuận/rủi ro 2.38.
